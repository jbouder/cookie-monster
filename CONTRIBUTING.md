...
5.  From your branch, make a pull request against `MSS/cookie-monster/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `MSS/cookie-monster/main`
...
docs. Please file an [issue](https://github.com/MSS/cookie-monster/issues).
-->
